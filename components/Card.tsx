...
export default function Card(props:Props){
    ...
    const { imagePath, title, className } = props

    return (
        <div className="relative w-fit h-fit group shadow-2xl cursor-pointer">
            <img src={imagePath} className={`${className} h-56 w-56 transition-transform duration-300 transform group-hover:scale-110 rounded-lg`}/>
